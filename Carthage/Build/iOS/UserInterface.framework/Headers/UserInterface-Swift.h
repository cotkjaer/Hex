...
@interface UICollectionView (SWIFT_EXTENSION(UserInterface))
@property (nonatomic, readonly, strong) NSIndexPath * _Nullable lastIndexPath;
@property (nonatomic, readonly, strong) NSIndexPath * _Nullable firstIndexPath;
@end


@interface UICollectionView (SWIFT_EXTENSION(UserInterface))
- (void)insertItemAtIndexPath:(NSIndexPath * _Nullable)indexPath;
- (void)deleteItemAtIndexPath:(NSIndexPath * _Nullable)indexPath;
- (void)reloadItemAtIndexPath:(NSIndexPath * _Nullable)indexPath;
- (void)moveItemFromIndexPath:(NSIndexPath * _Nullable)indexPath toIndexPath:(NSIndexPath * _Nullable)newIndexPath;
@end
...
///
/// <code>- parameter text: the new text
...
/// Sets views frame to match the drawing rectangle of the thumb image, given the current bounds and value of the slider
